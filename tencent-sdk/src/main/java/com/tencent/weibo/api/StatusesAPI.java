...
public class StatusesAPI extends BasicAPI {
	 ...
	 */
	public UserTimelineData userTimeline(OAuth oAuth, String format, String pageflag, String pagetime, String reqnum,
			String lastid, String name, String fopenid, String type, String contenttype) {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("pageflag", pageflag));
		paramsList.add(new BasicNameValuePair("pagetime", pagetime));
		...
		paramsList.add(new BasicNameValuePair("type", type));
		paramsList.add(new BasicNameValuePair("contenttype", contenttype));
		String resource = requestAPI.getResource(statusesUSERTimelineUrl, paramsList, oAuth);
		try {
	 ...
	 */
	public UserTimelineData mentionsTimeline(OAuth oAuth, String format, String pageflag, String pagetime,
			String reqnum, String lastid, String type, String contenttype) {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("pageflag", pageflag));
		paramsList.add(new BasicNameValuePair("pagetime", pagetime));
		...
		paramsList.add(new BasicNameValuePair("type", type));
		paramsList.add(new BasicNameValuePair("contenttype", contenttype));
		String resource = requestAPI.getResource(statusesMentionsTimelineUrl, paramsList, oAuth);
		try {
			UserTimeline result = mapper.readValue(resource, UserTimeline.class);
			if (ErrorCodeConstants.ret_0 == result.ret || ErrorCodeConstants.error_0 == result.errcode) {
				return result.getData();
	 ...
	 */
	public String broadcastTimeline(OAuth oAuth, String format, String pageflag, String pagetime, String reqnum,
			String lastid, String type, String contenttype) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("pageflag", pageflag));
		paramsList.add(new BasicNameValuePair("pagetime", pagetime));
		...
		return requestAPI.getResource(statusesBroadcastTimelineUrl, paramsList, oAuth);
	}
	 ...
	 */
	public String userTimelineIds(OAuth oAuth, String format, String pageflag, String pagetime, String reqnum,
			String lastid, String name, String fopenid, String type, String contenttype) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("pageflag", pageflag));
		paramsList.add(new BasicNameValuePair("pagetime", pagetime));
		...
		return requestAPI.getResource(statusesUserTimelineIdsUrl, paramsList, oAuth);
	}
	 ...
	 */
	public String usersTimeline(OAuth oAuth, String format, String pageflag, String pagetime, String reqnum,
			String lastid, String names, String fopenids, String type, String contenttype) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", format));
		paramsList.add(new BasicNameValuePair("pagetime", pagetime));
		paramsList.add(new BasicNameValuePair("pageflag", pageflag));
		...
		return requestAPI.getResource(statusesUsersTimelineUrl, paramsList, oAuth);
	}
